install.packages("nuclearARD_0.1.4.tgz", repos = NULL, type = "source") # Only needs to be run very first time
# devtools::install_github("mpleung/ARD", subdir="R/nuclear_ard") # Alternative installation if you have devtools installed
library(nuclearARD)
set.seed(0) # set seed
